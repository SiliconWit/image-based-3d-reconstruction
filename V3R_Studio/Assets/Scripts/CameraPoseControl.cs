...
namespace ThaIntersect.V3RLite{    
    public class CameraPoseControl : MonoBehaviour {
        ...
        protected void UpdateWayPointsAboutY(float x, float y, float z)
        {
            ...
            obj.transform.rotation = UtilFunctions.LookAtTargetYAxisOnly(obj.transform.position, target.position);
    ...
    static public class UtilFunctions{
        static public Quaternion LookAtTargetYAxisOnly(Vector3 from, Vector3 to)
        {
